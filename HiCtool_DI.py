...
def load_DI_values(input_file):
    ...
    Returns: 
        di_values: list of the DI values        
    """
    import numpy as np
...
def calculate_chromosome_DI(input_file, 
                            a_chr):
    """
...
def plot_chromosome_DI(input_file, 
                       a_chr, 
                       start_pos, 
                       end_pos, 
                       species='hg38',
...
def calculate_chromosome_true_DI(input_file,
                                 a_chr):
    """
...
def load_hmm_states(input_file):
    ...
    Returns: 
        likelystates: list of the hmm states       
    """
    fp = open(input_file,'r+')
    lines = fp.read().split('\n')
    lines = lines[:-1]
...
def plot_chromosome_DI_full(input_file_DI,
                            input_file_hmm,
                            a_chr, 
                            start_pos, 
                            end_pos, 
...
def calculate_chromosome_topological_domains(input_file,
                                             a_chr):
    """
    ...
    likelystates = load_hmm_states(input_file)
    bin_size = 40000    
